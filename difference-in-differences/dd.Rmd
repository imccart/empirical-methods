...
```{r}
knitr::include_url('https://imccart.github.io/empirical-methods-extras/difference-in-differences/slides/intro-cdc202108.html')
```

### DD

```{r}
knitr::include_url('https://imccart.github.io/empirical-methods-extras/difference-in-differences/slides/dd-cdc202108.html')
```
...
- [Basics of DD](https://imccart.github.io/empirical-methods-extras/difference-in-differences/slides/dd-cdc202108.html), **CDC Workshop**, August 2021
